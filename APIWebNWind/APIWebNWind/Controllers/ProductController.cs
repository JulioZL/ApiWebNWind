...
namespace APIWebNWind.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        //Petición get, trae todo lo de la url
        [HttpGet]
        ...
        [HttpGet]
        [Route("GetMaxProd/{year}")]
        public IEnumerable<object> GetMaxProd(int year)
        {
        ...
        [HttpGet]
        [Route("GetProdVentas/{productName}/{startDateStr}/{endDateStr}")]
        public IEnumerable<object> GetProdVentas(string productName, string startDateStr, string endDateStr)
        {
        ...
        [HttpGet]
        [Route("GetPeriodoTiempo/{startDate}/{endDate}")]
        public IEnumerable<object> GetPeriodoTiempo(string startDate, string endDate)
        {
